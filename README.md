...
- **Frontend Team Management**: Managed a team of 4 frontend developers by planning sprints, aligning tasks with team members' strengths, mentoring junior developers, and maintaining code quality through reviews and shared component standards.
- **Component Library & Design System**: Developed a sharable component library and established a design system taxonomy for colors, fonts, and spacing. Utilized **Storybook** to drive team collaboration and documentation, resulting in consistent UI and **reduced development time** across projects.
- **Cross-Team Collaboration**: Collaborated with product managers, UI/UX designers, and backend engineers to align sprint goals and propose a simplified user flow, reducing validation complexity and development effort, **accelerated delivery** by 50%, and enhanced user satisfaction.
...
#### December 2019 - December 2023: Professional Software Engineer, (_Comerge Solutions Sdn Bhd_)
...
#### June 2018 - December 2019: Senior Mobile Engineer, (_Hitachi eBworx Sdn Bhd_)
